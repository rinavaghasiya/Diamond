                                ...
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="row form-group mt-2">
                                            ...
                                            <div class="col-11">
                                                <input type="email" placeholder="e.g. John Doe" id="email-input" name="email-input" class="form-control">
                                            </div>
                                            <div class="col col-md-12 mt-2"><label class=" form-control-label">Email Address</label></div>
                                            <div class="col-11">
                                                <input type="email" placeholder="e.g. email@xyzgmail.com" id="email-input" name="email-input" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
