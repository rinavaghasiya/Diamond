                                ...
                                <div class="row">
                                    <div class="col-lg-10">
                                        <div class="row form-group mt-2">
                                            ...
                                            <div class="col-11">
                                                <input type="email" placeholder="e.g. My company" id="email-input" name="email-input" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <a href=""><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa fa-camera-retro"></i> Your logo </button></a>
                                    </div>
                                </div>
                                <div class="row mt-5">
