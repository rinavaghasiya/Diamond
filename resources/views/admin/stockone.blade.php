...
<head>
    ...
    <link rel="stylesheet" href="../../cdn.jsdelivr.net/npm/pixeden-stroke-7-icon%401.2.3/pe-icon-7-stroke/dist/pe-icon-7-stroke.min.css">
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index-2.html"><span>Stock</span></a>
        ...
        <div class="card-header">
            <strong class="card-title"><a href="centerdepartment.html"><i class="fa-solid fa-table-columns"></i></a> <a href="stock1.html">Stock</a></strong>
            <ul class="stockul">
                <li class="stockli mt-2 nav-item dropdown">
                    ...
                    <ul class="dropdown-menu mt6" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="stock1.html">Lot</a></li>
                        <li><a class="dropdown-item" href="packets.html">Packets</a></li>
                    </ul>
                </li>
                <li class="stockli"><a class=" mt-1" data-bs-toggle="modal" data-bs-target="#addpacketsModal">Add Packets</a></li>
                <li class="stockli"><a href="cancelpackets.html">Cancel Packets</a></li>
                <li class="stockli"><a class=" mt-1" data-bs-toggle="modal" data-bs-target="#editpacketsModal">Edit Packets</a></li>
                <li class="stockli"><a href="stockloss.html">Stock Loss</a></li>
                <li class="stockli"><a class=" mt-1" data-bs-toggle="modal" data-bs-target="#stockreportpacketsModal">Report</a></li>
                <li class="stockli"><a href="weightloss.html">Weight Loss</a></li>
                <li class="stockli"><a href="chocolate.html">Chocolate</a></li>
                <li class="stockli nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Configuration</a>
                    <ul class="dropdown-menu mt6" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="stockmove.html">Stock Move</a></li>
                        <li><a class="dropdown-item" href="stockquant.html">Stock Quant</a></li>
                    </ul>
                </li>
            </ul>
                                        ...
                                        <div class="card-body card-block">
                                            <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col col-md-9"><label class=" form-control-label"><img src="./assets/img/barcode.webp" alt=""></label></div>
                                                </div>
                                                <div class="row form-group">
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="stock1.html"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="stocklist.html"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Scripts -->
        <script src="../../cdn.jsdelivr.net/npm/jquery%402.2.4/dist/jquery.min.js "></script>
        <script src="../../cdn.jsdelivr.net/npm/popper.js%401.14.4/dist/umd/popper.min.js "></script>
        <script src="../../cdn.jsdelivr.net/npm/bootstrap%404.1.3/dist/js/bootstrap.min.js "></script>
        <script src="../../cdn.jsdelivr.net/npm/jquery-match-height%400.7.2/dist/jquery.matchHeight.min.js "></script>
